...
SIMBOLOS = ({COM_DOBLE}|{COM_SIMPLE}|{MULT}|{PLUS}|{COMA}|{DOS_PUNTOS}|{PUNTO_COMA}|{ITR}|{DISY}|{LLAV_ABIERTA}|{LLAV_CERRADA})
...
/* Comentarios */
COMENTARIO_SIMPLE = "//"+ ({SPACE}|{LETRA}|{ENTERO}|{ASCII}|{SIMBOLOS}) ({SPACE}|{LETRA}|{ENTERO}|{ASCII}|{SIMBOLOS})*
COMENTARIO_EXTENSO = "<!"({ENTER}|{SPACE}|{LETRA}|{ENTERO}|{ASCII}|{SIMBOLOS}) ({ENTER}|{SPACE}|{LETRA}|{ENTERO}|{ASCII}|{SIMBOLOS})* "!>"
...
<YYINITIAL> . {
        ...
        br.ErroresL("<h4>Error léxico: "+yytext()+" Linea: "+(yyline+1)+" Columna: "+(yycolumn+1)+"</h4>");

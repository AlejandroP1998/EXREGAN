...
public class transitionTable {
    ...
    public void GenerarDot(String cadena, String name) {
        ...
        String ruta = "C:\\Users\\1998j\\OneDrive\\Desktop\\Proyecto 1\\Reportes\\TRANSICIONES_201712602\\" + name + ".dot";
        try {
    ...
    public void dibujarGraphviz(String ruta, String name) {
        try {
            ...
            String imagenRuta = "C:\\Users\\1998j\\OneDrive\\Desktop\\Proyecto 1\\Reportes\\TRANSICIONES_201712602\\" + name + ".jpg";
    ...
    public void GenerarDotAFD(String cadena, String name) {
        FileWriter fichero = null;
        String ruta = "C:\\Users\\1998j\\OneDrive\\Desktop\\Proyecto 1\\Reportes\\AFD_201712602\\" + name + ".dot";
        try {
            fichero = new FileWriter(ruta);
            PrintWriter pw = null;
            pw = new PrintWriter(fichero);
    ...
    public void dibujarGraphvizAFD(String ruta, String name) {
        try {
            ...
            ProcessBuilder pbuilder;
            String imagenRuta = "C:\\Users\\1998j\\OneDrive\\Desktop\\Proyecto 1\\Reportes\\AFD_201712602\\" + name + ".jpg";
            pbuilder = new ProcessBuilder("dot", "-Tjpg", "-o",
                    imagenRuta,
                    ruta);
            pbuilder.redirectErrorStream(true);

...
public class Brain {
    ...
    public ArrayList<String> errorsL = new ArrayList<>();
    public ArrayList<String> errorsS = new ArrayList<>();
    ...
    public void analizarER(String er, String expName) {
        ...
        try {
            ...
            arbol.GenerarDot(tbl, "tbl-" + expName);
            ...
            this.ErroresS("No se logro leer la expresion: "+expName);
        }
    ...
    public void AnalizarEntrada(String name, String cadena) {
        ...
        if (encontrado) {
            ...
            this.ErroresS("No se encontro la expresion " + name);
        }

    }

    public void ErroresL(String error) {
        String p1 = "<!DOCTYPE html>\n"
                ...
                + "    <h1 class=\"p-4\">Listado de errores lexicos encontrados en la compilación</h1>\n"
                + "    <ul>";
        ...
        this.errorsL.add(error);
        FileWriter fichero;
        String ruta = "C:\\Users\\1998j\\OneDrive\\Desktop\\Proyecto 1\\Reportes\\ERRORES_201712602\\erroresL.html";
        try {
            fichero = new FileWriter(ruta);
            PrintWriter pw;
            pw = new PrintWriter(fichero);
            pw.write(p1);
            for (int i = 0; i < this.errorsL.size(); i++) {
                pw.write("\t\t<li>" + this.errorsL.get(i) + "</li>\n");
            }
            pw.write(p2);
            pw.close();
            fichero.close();
    ...
    public void ErroresS(String error) {
        String p1 = "<!DOCTYPE html>\n"
                + "<html lang=\"en\">\n"
                + "\n"
                + "<head>\n"
                ...
                + "<body>\n"
                + "  <div class=\"container d-flex flex-column justify-content-center align-items-center my-5\">\n"
                + "    <h1 class=\"p-4\">Listado de errores sintacticos encontrados en la compilación</h1>\n"
                + "    <ul>";
        ...
        this.errorsS.add(error);
        FileWriter fichero;
        String ruta = "C:\\Users\\1998j\\OneDrive\\Desktop\\Proyecto 1\\Reportes\\ERRORES_201712602\\erroresS.html";
        try {
            fichero = new FileWriter(ruta);
            PrintWriter pw;
            pw = new PrintWriter(fichero);
            pw.write(p1);
            for (int i = 0; i < this.errorsS.size(); i++) {
                pw.write("\t\t<li>" + this.errorsS.get(i) + "</li>\n");
            }
            pw.write(p2);
            pw.close();
            fichero.close();

...
//        System.out.println(seleccion);
    ...
    private void erroresbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_erroresbtnActionPerformed
        try {
            File file = new File("C:\\Users\\1998j\\OneDrive\\Desktop\\Proyecto 1\\Reportes\\ERRORES_201712602\\erroresL.html");
            File file2 = new File("C:\\Users\\1998j\\OneDrive\\Desktop\\Proyecto 1\\Reportes\\ERRORES_201712602\\erroresS.html");
            ...
            if (file.exists()) {
                terminal.setText("Archivos de errores abiertos, revise su navegador predeterminado");
                desktop.open(file);
                desktop.open(file2);
            }
        } catch (IOException e) {
